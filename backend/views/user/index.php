	...
	<form method="post" action="/mrsblog/backend/web/index.php?r=slideshow%2Fdelete" id="dltForm">
		<table class="table table-hover">
			...
			<tbody>
						...
						<td>#</td>
						<td>开启</td>
						<td><a href="#" title="编辑" class="data_op data_edit"></a> | <a href="javascript:void(0);" title="删除" class="data_op data_delete"></a></td>
						</tr>
			</tbody>
		</table>
	</form>
	<ul class="pagination"><li class="prev disabled"><span>«</span></li>
		<li class="active"><a data-page="0" href="/mrsblog/backend/web/index.php?r=article%2Findex&amp;page=1">1</a></li>
